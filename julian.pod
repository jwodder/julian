...
specifying a time in UTC.  (A year value of 0 corresponds to 1 BC, a year value
of -1 corresponds to 2 BC, and so forth.)  The day may alternatively be
specified as C<YYYY-DDD>, where the second component is the day of the year
from 001 to 366.
...
Print out the input date and C< = > before each respective output date.
